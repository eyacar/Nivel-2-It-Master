  ...
  return (
    <>
      <input
        ...
        onChange={Buscando}
      />
      {/* Whith the className configure the preload image*/}
      <img
        className={preload === true ? "preload" : null}
...
const Libro = () => {
  ...
  return (
    <div id="elegido">
      ...
      {Datos ? (
        Datos.filter((libro) => libro.isbn === params.id).map((libro, i) => (
          <ul>
            <li>
              <span className="titulos">Titulo: </span>
              {libro.title}
            </li>
            <li>
              <span className="titulos">Codigo del libro: </span>
              {libro.isbn}
            </li>
            <li>
              <span className="titulos">Cantidad de paginas: </span>
              {libro.pageCount}
            </li>
            <li>
              <span className="titulos">Tapa: </span>
              <br />
              <br /> <img src={libro.thumbnailUrl} alt="Tapa" />
            </li>
            <li>
              <span className="titulos">Descripción: </span>
              {libro.longDescription}
            </li>
            <li>
            ...
            <li>
              <span className="titulos">Categoria: </span>
              {libro.categories}
            </li>
          </ul>
        ))
